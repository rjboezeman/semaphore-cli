        ...
        "inventories": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    # File-type inventories load the inventory from a file in a
                    # repository. 'repository' names that repository and
                    # 'inventory' holds the file path within it.
                    "repository": {"type": "string"},
                },
                # A file-type inventory must name a repository and a file path.
                "if":   {"required": ["type"], "properties": {"type": {"const": "file"}}},
                "then": {"required": ["repository", "inventory"],
                         "properties": {"inventory": {"minLength": 1}}},
            },
        },
        "environments": {
            "type": "array",
